...
#add events
event = Event.new({'id' => '1', 'name' => '100m sprint', 'participation_type' => 'athlete', 'max_capacity' => '10', 'world_record' => '9.2', 'sport_id' => rowing.id}).save
event1 = Event.new({'id' => '1', 'name' => '100m sprint', 'participation_type' => 'team', 'max_capacity' => '10', 'world_record' => '9.2', 'sport_id' => rowing.id}).save
